...
<template>
  <main class="px-[3vw] py-3 h-screen overflow-y-scroll flex flex-wrap justify-between">
    <header class="flex h-[9vh] w-full items-center gap-4 mb-3">
      ...
      <h1 class="text-black text-2xl leading-none align-middle p-0 m-0 mt-1.5 whitespace-nowrap">
      ...
      <section class="w-8/12 classic-box-dark min-h-[80vh] rounded-2xl p-6">
        <div class="flex items-center justify-center h-10">
          <input
            ...
            class="h-full w-full text-lg p-3 rounded-xl mr-9 shadow text-black"
            type="text"
            placeholder="Adicione um nome para sua lista..."
          />
          <button
            @click.stop="goToAddToList"
            class="flex items-center h-full p-2 aspect-square bg-main rounded-xl hover:cursor-pointer shadow"
          >
      ...
      <section class="w-3/12 h-[84vh] flex flex-col justify-between flex-[0_0_auto]">
        <div class="classic-box-dark h-full rounded-2xl flex flex-col p-6">
          ...
          <textarea
            ...
            class="text-black classic-box rounded-xl h-2/6 p-2"
